<?php 
    ...
    if(strlen($_SESSION['login'])==0){ 
        ...
        if(isset($_GET['kode']) && $_GET['action']=='del'){
            $kategoriid=$_GET['kode'];
            $query=mysqli_query($con,"delete from category where id_category='$kategoriid'");
            header('location:kategori.php');
        }
        if(isset($_POST['submit'])){
            $kategori = $_POST['kategoriBaru'];
            $query = mysqli_query($con, "insert into category(jenis) values('$kategori')");
            header("location:kategori.php");
        }
                                ...
                                <div class="module-body control-group">
                                    <form class="form-horizontal row-fluid" name="Category" method="post" >
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" placeholder="Masukkan nama kategori baru"  name="kategoriBaru" class="span8 tip" required>
                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display">
                                        ...
                                        <tbody>
                                            <?php 
                                                $q4 = mysqli_query($con, "SELECT * FROM category order by jenis asc"); 
                                                $i=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="updateKategori.php?kode=<?php echo htmlentities($row['id_category']) ?>"><i class="icon-edit"></i></a>
                                                        <a href="kategori.php?kode=<?php echo htmlentities($row['id_category']) ?>&&action=del" title="delete" onclick="return confirm('Apakah anda ingin menghapus kategori ini?')"><i class="icon-remove-sign"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $i++; } ?>
                                        </tbody>

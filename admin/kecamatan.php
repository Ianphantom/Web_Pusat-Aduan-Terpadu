<?php 
    ...
    if(strlen($_SESSION['login'])==0){ 
        ...
        if(isset($_GET['kode']) && $_GET['action']=='del'){
            $kecamatanid=$_GET['kode'];
            $query=mysqli_query($con,"delete from kecamatan where id='$kecamatanid'");
            header('location:kecamatan.php');
        }
        if(isset($_POST['submit'])){
            $kecamatan = $_POST['kecamatanBaru'];
            $query = mysqli_query($con, "insert into kecamatan(nama) values('$kecamatan')");
            header("location:kecamatan.php");
        }
                                ...
                                <div class="module-body control-group">
                                    <form class="form-horizontal row-fluid" name="Category" method="post" >
                                        ...
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Nama Kecamatan</label>
                                            <div class="controls">
                                                <input type="text" placeholder="Masukkan nama kecamatan baru"  name="kecamatanBaru" class="span8 tip" required>
                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display">
                                        ...
                                        <tbody>
                                            <?php 
                                                $q4 = mysqli_query($con, "SELECT * FROM kecamatan order by nama asc"); 
                                                $i=1;
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="updateKecamatan.php?kode=<?php echo htmlentities($row['id']) ?>"><i class="icon-edit"></i></a>
                                                        <a href="kecamatan.php?kode=<?php echo htmlentities($row['id']) ?>&&action=del" title="delete" onclick="return confirm('Apakah anda ingin menghapus kecamatan ini?')"><i class="icon-remove-sign"></i></a>
                                                    </td>
                                                </tr>
                                                <?php $i++; } ?>
                                        </tbody>

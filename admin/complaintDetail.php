                    ...
                    <div class="span9">
                        ...
                        <div class="module">
                                <div class="module-head">
                                    <h3>Komplain Details</h3>
                                </div>
                                <?php 
                                    $details = mysqli_query($con, "select * from daftar_komplain inner join users ON daftar_komplain.id_user=users.id inner join category on daftar_komplain.category=category.id_category where nomor_komplain='$nomorKomplain'");
                                ...
                                <div class="module-body table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
                                        width="100%">
                                        <tr>
                                            <td><strong>Nomor Komplain</strong></td>
                                            <td><?php echo htmlentities($rowdetails['nomor_komplain']) ?></td>
                                            <td><strong>Pengaduan</strong></td>
                                            <td><?php echo htmlentities($rowdetails['name']) ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Tanggal Pengajuan</strong></td>
                                            <td><?php echo htmlentities($rowdetails['regDate']) ?></td>
                                            <td><strong>Kecamatan</strong></td>
                                            <td><?php echo htmlentities($rowdetails['kecamatan']) ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Kategori</strong></td>
                                            <td><?php echo htmlentities($rowdetails['jenis']) ?></td>
                                            <td><strong>Sub-Kategori</strong></td>
                                            <td><?php echo htmlentities($rowdetails['subCategory']) ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Masalah</strong></td>
                                            <td><?php echo htmlentities($rowdetails['masalah']) ?></td>
                                            <td><strong>Detail</strong></td>
                                            <td><?php echo htmlentities($rowdetails['detail']) ?></td>
                                        </tr>
                                        <tr>
                                            <td><strong>File</strong></td>
                                            <td colspan="3">
                                            <?php
                                                    if($rowdetails['bukti']==NULL || $rowdetails['bukti']==""){
                                                        echo htmlentities("Tidak ada dokumen pendukung");
                                                    }else { ?>
                                                        <a href="dokumencomplaint/<?php echo htmlentities($rowdetails['bukti']) ?>" target="_blank"><p style="color:blue"><?php echo htmlentities($rowdetails['bukti'])?></p></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                        <tr>

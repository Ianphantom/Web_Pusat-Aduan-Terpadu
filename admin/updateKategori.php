<?php 
    ...
    if(strlen($_SESSION['login'])==0){ 
        ...
        if(isset($_POST['submit'])){
            ...
            $query = mysqli_query($con, "update category set jenis='$kategori' where id_category='".$_GET['kode']."'");
                            ...
                            <div class="module">
                                ...
                                <div class="module-body control-group">
                                    <form class="form-horizontal row-fluid" name="Category" method="post" >
                                        <?php 
                                            $querykategori = mysqli_query($con, "select * from category where id_category='".$_GET['kode']."'");
                                            $namakategori = mysqli_fetch_array($querykategori);
                                        ?>
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Perbarui Kategori</label>
                                            <div class="controls">
                                                <input type="text"  name="kategoriBaru" class="span8 tip" required placeholder="<?php echo htmlentities($namakategori['jenis']) ?>">

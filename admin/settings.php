<?php 
    ...
    if(strlen($_SESSION['login'])==0){ 
        ...
        $query=mysqli_query($con,"select * from adm where username='".$_SESSION['login']."'");
		$row=mysqli_fetch_array($query);
        if(isset($_POST['submit'])){
            $pass = md5($_POST['password']);
            if($row['password']==$pass){
                $newpass = md5($_POST['newpass']);
                mysqli_query($con, "update adm set password='$newpass' where password='$pass'");
                $msg = "Password Anda telah diganti";
            }else{
                        ...
                        <div class="content">
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    ...
                                    <?php } ?>
                                    <form method="post" name="profile" style="text-align:left;background:white;width:80%;margin:auto auto;">
                            ...
                            <div class="module">
                                ...
                                <div class="module-body table">
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display">
                                        ...
                                        <tbody>
                                            <?php 
                                                $q4 = mysqli_query($con, "select * from admlog"); 
                                                $i=1;

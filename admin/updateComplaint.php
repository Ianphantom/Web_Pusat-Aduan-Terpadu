                    ...
                    <div class="span9">
                        <div class="content">
                            <div class="module" style="padding: 20px">
                                <h3>Remark Form</h3>
                                <form class="form-control" name="remark" method="post">
                                <label><strong>Nomor Komplain</strong></label>
                                <input type="text" class="form-control" name="nomor_komplain" readonly required autofocus value="<?php echo htmlentities($_GET['kode']) ?>" style="border:none">

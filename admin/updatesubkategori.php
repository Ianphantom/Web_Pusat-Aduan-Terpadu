<?php 
    ...
    if(strlen($_SESSION['login'])==0){ 
        ...
        if(isset($_POST['submit'])){
            ...
            $query = mysqli_query($con, "update subcategory set jenis='$subkategori' where id_sub='".$_GET['kode']."'");
                                ...
                                <div class="module-body control-group">
                                    <form class="form-horizontal row-fluid" name="Category" method="post" >
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select name="id_category" id="category" readonly>
                                                    <?php 
                                                        $category = mysqli_query($con, "select A.jenis as jenis, B.jenis as jenisa from category AS A INNER JOIN subcategory AS B on b.id_category=A.id_category where id_sub='".$_GET['kode']."' ");
                                        ...
                                        <div class="control-group">
                                            <?php
                                                $subc = mysqli_query($con, "select * from subcategory where id_sub='".$_GET['kode']."'");
                                                $rowsubc = mysqli_fetch_array($subc);
                                            ?>
                                            <label class="control-label" for="basicinput">Nama Sub-Kategori</label>
                                            <div class="controls">
                                                <input type="text" placeholder="<?php echo htmlentities($rowsubc['jenis']) ?>"  name="subkategoriBaru" class="span8 tip" required>

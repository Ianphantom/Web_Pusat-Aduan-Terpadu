<?php 
    ...
    if(strlen($_SESSION['login'])==0){ 
        ...
        if(isset($_POST['submit'])){
            ...
            $query = mysqli_query($con, "update kecamatan set nama='$kecamatan', UpdateDate=CURRENT_TIMESTAMP() where id='".$_GET['kode']."'");
                        ...
                        <div class="content">
                            <div class="module">
                                <div class="module-head">
                                    <h3>Update Kecamatan</h3>
                                </div>
                                <div class="module-body control-group">
                                    <form class="form-horizontal row-fluid" name="Category" method="post" >
                                        <?php 
                                            $querykecamatan = mysqli_query($con, "select * from kecamatan where id='".$_GET['kode']."'");
                                            $namaKecamatan = mysqli_fetch_array($querykecamatan);
                                        ?>
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Perbarui Kecamatan</label>
                                            <div class="controls">
                                                <input type="text"  name="kecamatanBaru" class="span8 tip" required placeholder="<?php echo htmlentities($namaKecamatan['nama']) ?>">
